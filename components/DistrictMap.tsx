      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {district.status === "available" ? (
                      <div className="flex items-center gap-2 text-green-600">
                        ...
                        <span className="font-semibold">{t.districts.availableNow}</span>
                      </div>
                    ) : (
          ...
          <motion.div
            ...
            className="bg-white rounded-xl p-8 shadow-lg"
          >
            <h3 className="text-2xl font-bold mb-6">{t.districts.checkDistrict}</h3>
            ...
            <form className="space-y-4">
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                  <option value="">{t.districts.chooseDistrict}</option>
                  {districts.map((district) => (
              ...
              >
                {t.districts.getNotified}
              </button>
            </form>

            <div className="mt-6 p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-gray-700">
                <strong>{t.districts.notInDistrict}</strong> {t.districts.notInDistrictDesc}
              </p>
            </div>
          </motion.div>
        </div>
